...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        Button1 = CreateWindow(TEXT("button"), TEXT("Open")
            , WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON | BS_MULTILINE, 50, 100, 170, 30
            , hwnd, (HMENU)(OBJ_ID100), ((LPCREATESTRUCT)lParam)->hInstance, NULL);

        OpenDialog1.lStructSize = sizeof(OPENFILENAME);
        OpenDialog1.hwndOwner = hwnd;
        OpenDialog1.hInstance = NULL;
        OpenDialog1.lpstrFilter = TEXT("Szövegfájl (.txt)\0*.txt\0");
        OpenDialog1.lpstrCustomFilter = NULL;
        OpenDialog1.nMaxCustFilter = 0;
        OpenDialog1.nFilterIndex = 1;
        OpenDialog1.lpstrFile = mypath;
        OpenDialog1.nMaxFile = MAX_PATH;
        OpenDialog1.lpstrFileTitle = myfile;
        OpenDialog1.nMaxFileTitle = MAX_PATH;
        OpenDialog1.lpstrInitialDir = TEXT("C:\\");
        OpenDialog1.lpstrTitle = TEXT("Open file");
        OpenDialog1.Flags = OFN_PATHMUSTEXIST | OFN_FILEMUSTEXIST;
        OpenDialog1.nFileOffset = 0;
        OpenDialog1.nFileExtension = 0;
        OpenDialog1.lpstrDefExt = NULL;
        OpenDialog1.lCustData = 0L;
        OpenDialog1.lpfnHook = NULL;
        OpenDialog1.lpTemplateName = NULL;
    ...
    case WM_COMMAND:
        ...
        {
        case OBJ_ID100:
            if (GetOpenFileName(&OpenDialog1))
            {
