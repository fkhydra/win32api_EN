...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        /*Init*/;
        RadioButton1 = CreateWindow(TEXT("button"), TEXT("RadioButton1")
            , WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON | BS_MULTILINE, 50, 50, 170, 30
            , hwnd, (HMENU)(OBJ_ID100), ((LPCREATESTRUCT)lParam)->hInstance, NULL);
        RadioButton2 = CreateWindow(TEXT("button"), TEXT("RadioButton2")
            , WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON | BS_MULTILINE, 50, 90, 170, 30
            , hwnd, (HMENU)(OBJ_ID101), ((LPCREATESTRUCT)lParam)->hInstance, NULL);
        SendMessage(RadioButton2, BM_SETCHECK, BST_CHECKED, 0);
        return 0;
        //*********************************
        //Handle scrolling
        //*********************************
    ...
    case WM_COMMAND:
        ...
        {
        case OBJ_ID100:
            MessageBox(NULL, L"Clicking detected!", L"User interaction", MB_OK | MB_ICONINFORMATION);
            break;
        }
