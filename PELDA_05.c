...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        /*Init*/;
        CheckBox1 = CreateWindow(TEXT("button"), TEXT("CheckBox1")
            , WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX | BS_MULTILINE, 50, 50, 170, 30
            , hwnd, (HMENU)(OBJ_ID100), ((LPCREATESTRUCT)lParam)->hInstance, NULL);
        CheckBox2 = CreateWindow(TEXT("button"), TEXT("CheckBox2")
            , WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX | BS_MULTILINE, 50, 90, 170, 30
