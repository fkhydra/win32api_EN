...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        /*Init*/;
        UpDown1 = CreateWindowEx(0, UPDOWN_CLASS, (LPCWSTR)NULL, WS_CHILD | WS_VISIBLE, 50, 50, 40, 40
    ...
    case WM_VSCROLL:
        ...
        //*********************************
    case WM_NOTIFY: {
        switch (((LPNMUPDOWN)lParam)->hdr.idFrom)
        {
        case OBJ_ID100:
            if ((((LPNMUPDOWN)lParam)->iDelta) >= 0) MessageBox(NULL, L"Clicking down!", L"User interaction", MB_OK | MB_ICONINFORMATION);
            if ((((LPNMUPDOWN)lParam)->iDelta) < 0) MessageBox(NULL, L"Clicking up!", L"User interaction", MB_OK | MB_ICONINFORMATION);
            break;
        }
        return 0;
    }
