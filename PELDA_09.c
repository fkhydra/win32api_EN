...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        /*Init*/;
        HScrollBar1 = CreateWindow(TEXT("scrollbar"), (LPCWSTR)NULL, WS_CHILD | WS_VISIBLE | SBS_HORZ, 50, 50, 300, 30,
            hwnd, (HMENU)(OBJ_ID100), ((LPCREATESTRUCT)lParam)->hInstance, NULL);
        SendMessage(HScrollBar1, SBM_SETRANGE, 10, 100);
        SendMessage(HScrollBar1, SBM_SETPOS, 20, TRUE);
        return 0;
        //*********************************
        //Handle scrolling
        //*********************************
    case WM_HSCROLL:
        switch (LOWORD(wParam))
        {
            case SB_LINELEFT:
            {
                ...
                {
                case OBJ_ID100:
                    MessageBoxA(NULL, "Clicking to the left", "User interaction", MB_OK | MB_ICONINFORMATION);
                    break;
                }
            }
            break;
            case SB_LINERIGHT:
            {
                ...
                {
                case OBJ_ID100:
                    MessageBoxA(NULL, "Clicking to the right", "User interaction", MB_OK | MB_ICONINFORMATION);
                    break;
                }
            }
            break;
            ...
            case SB_PAGELEFT:
            {
                ...
                case OBJ_ID100:
                    ...
                    strcpy_s(mymessage, "Page left, new position: ");
                    s1 = SendMessage(HScrollBar1, SBM_GETPOS, 0, 0);
                    _itoa_s(s1 - 10, ertek, 10);
                    strcat_s(mymessage, ertek);
                    SendMessage(HScrollBar1, SBM_SETPOS, s1 - 10, TRUE);
            ...
            case SB_PAGERIGHT:
            {
                ...
                case OBJ_ID100:
                    ...
                    strcpy_s(mymessage, "Page right, new position: ");
                    s1 = SendMessage(HScrollBar1, SBM_GETPOS, 0, 0);
                    _itoa_s(s1+10,ertek,10);
                    strcat_s(mymessage, ertek);
                    SendMessage(HScrollBar1, SBM_SETPOS, s1+10, TRUE);
