...
HWND Button1;
HCURSOR myCcursor;
HCURSOR myCustomCcursor;
BOOL swap_cursor = FALSE;
...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        myCcursor = LoadCursor(NULL, IDC_PIN);
        SetCursor(myCcursor);
        return 0;
        //*********************************
        //Handle scrolling
    ...
    case WM_SETCURSOR:
        ...
        {
            if (swap_cursor) SetCursor(myCustomCcursor);
            else SetCursor(myCcursor);
            return TRUE;
        }
        break;
    case WM_HSCROLL:
    ...
    case WM_COMMAND:
        ...
        case OBJ_ID100:
            if (!swap_cursor)
            {
                ...
                myCustomCcursor = CreateCursor(hInstGlob,
                    2, 
                    2,
                    32,
                    32, 
            ...
            MessageBox(NULL, L"Cursor changed!", L"User interaction", MB_OK | MB_ICONINFORMATION);
            break;
        }
