...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        /*Init*/;
        Button1 = CreateWindow(TEXT("button"), TEXT("Play")
    ...
    case WM_COMMAND:
        ...
        {
        case OBJ_ID100:
            PlaySound(TEXT("hang.wav"), NULL, SND_FILENAME | SND_ASYNC);
            MessageBox(NULL, L"Playback has started!", L"User interaction", MB_OK | MB_ICONINFORMATION);
            break;
        }
