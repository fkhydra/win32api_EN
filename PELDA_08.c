...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        /*Init*/;
        ComboBox1 = CreateWindow(TEXT("combobox"), NULL
            , WS_CHILD | WS_VISIBLE | WS_VSCROLL | CBS_DROPDOWNLIST, 50, 50, 200, 100
            , hwnd, (HMENU)(OBJ_ID100), ((LPCREATESTRUCT)lParam)->hInstance, NULL);
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listitem 1");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listitem 2");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listitem 3");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listitem 4");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listitem 5");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listitem 6");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listitem 7");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listitem 8");
        return 0;
        //*********************************
        //Handle scrolling
        //*********************************
    ...
    case WM_COMMAND:
        ...
        if (LOWORD(wParam) == OBJ_ID100 && HIWORD(wParam) == LBN_SELCHANGE)
        {
            ...
            myIndex = (int)SendMessage(ComboBox1, CB_GETCURSEL, (WPARAM)0, (LPARAM)0);
            length = (int)SendMessage(ComboBox1, CB_GETLBTEXTLEN, (WPARAM)myIndex, 0);
            SendMessageA(ComboBox1, CB_GETLBTEXT, (WPARAM)myIndex, (LPARAM)item_name);
