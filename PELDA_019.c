...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        /*Init*/;
        StatusBar1 = CreateWindowEx(0, STATUSCLASSNAME, (LPCWSTR)NULL, WS_CHILD | WS_VISIBLE | SBARS_SIZEGRIP, 50, 50, 70, 30
            , hwnd, (HMENU)(OBJ_ID100), ((LPCREATESTRUCT)lParam)->hInstance, NULL);
        int myWidths[2];
        myWidths[0] = 100;
        myWidths[1] = 442;
        SendMessage(StatusBar1, SB_SETPARTS, 2, (LPARAM)&myWidths);
        SendMessage(StatusBar1, SB_SETTEXT, 0, (LPARAM)TEXT("TEXT1"));
        SendMessage(StatusBar1, SB_SETTEXT, 1, (LPARAM)TEXT("TEXT2"));
        return 0;
        //*********************************
        //Handle scrolling
        //*********************************
    ...
    case WM_SIZE:
        RECT ablakkeret;
        GetWindowRect(hwnd,&ablakkeret);
        SetWindowPos(
            StatusBar1,
            HWND_TOPMOST,
            20,
            ablakkeret.bottom-30,
            ablakkeret.right - ablakkeret.left,
            30,
            SWP_NOZORDER);
