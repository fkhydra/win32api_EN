...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        /*Init*/;
        GroupBox2 = CreateWindow(TEXT("button"), TEXT("GroupBox")
            , WS_CHILD | WS_VISIBLE | BS_GROUPBOX | BS_MULTILINE, 50, 50, 250, 150
            , hwnd, (HMENU)(OBJ_ID100), ((LPCREATESTRUCT)lParam)->hInstance, NULL);
        Button1 = CreateWindow(TEXT("button"), TEXT("MyButton")
            , WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON | BS_MULTILINE, 10, 40, 170, 30
            , GroupBox2, (HMENU)(OBJ_ID101), ((LPCREATESTRUCT)lParam)->hInstance, NULL);
        return 0;
        //*********************************
        //Handle scrolling
        //*********************************
